(() => {
    ...
    if (typeof dealerSum === 'undefined') {
        var dealerSum = 0; // use var instead of let/const if you're doing this
    }
    console.log("AFTER" + new Date().toLocaleString());
    if (typeof yourSum === 'undefined') {
        var yourSum = 0; // use var instead of let/const if you're doing this
    }
    ...
    console.log("DEBUG MAIN" + new Date().toLocaleString());

    window.onload = function () {

        console.log("DEBUG ONLOAD " + new Date().toLocaleString());
        buildDeck();
        shuffleDeck();
        startGame();
